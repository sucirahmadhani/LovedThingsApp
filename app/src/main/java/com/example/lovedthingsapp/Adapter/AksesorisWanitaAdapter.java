...
public class AksesorisWanitaAdapter extends RecyclerView.Adapter<AksesorisWanitaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public AksesorisWanitaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AksesorisWanitaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new AksesorisWanitaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull AksesorisWanitaAdapter.ViewHolder holder, int position) {
