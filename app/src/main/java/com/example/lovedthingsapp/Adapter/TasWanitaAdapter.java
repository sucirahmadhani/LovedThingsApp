...
public class TasWanitaAdapter extends RecyclerView.Adapter<TasWanitaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public TasWanitaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public TasWanitaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new TasWanitaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull TasWanitaAdapter.ViewHolder holder, int position) {
