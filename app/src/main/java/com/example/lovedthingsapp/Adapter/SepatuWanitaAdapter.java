...
public class SepatuWanitaAdapter extends RecyclerView.Adapter<SepatuWanitaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public SepatuWanitaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public SepatuWanitaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new SepatuWanitaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull SepatuWanitaAdapter.ViewHolder holder, int position) {
