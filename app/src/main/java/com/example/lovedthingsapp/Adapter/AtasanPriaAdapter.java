...
public class AtasanPriaAdapter extends RecyclerView.Adapter<AtasanPriaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public AtasanPriaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AtasanPriaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new AtasanPriaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanPriaAdapter.ViewHolder holder, int position) {
