...
public class TasPriaAdapter extends RecyclerView.Adapter<TasPriaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public TasPriaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public TasPriaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new TasPriaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull TasPriaAdapter.ViewHolder holder, int position) {
