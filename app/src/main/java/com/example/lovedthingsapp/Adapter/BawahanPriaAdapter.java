...
public class BawahanPriaAdapter extends RecyclerView.Adapter<BawahanPriaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public BawahanPriaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public BawahanPriaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new BawahanPriaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull BawahanPriaAdapter.ViewHolder holder, int position) {
