...
public class AtasanWanitaAdapter extends RecyclerView.Adapter<AtasanWanitaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public AtasanWanitaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public AtasanWanitaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new AtasanWanitaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull AtasanWanitaAdapter.ViewHolder holder, int position) {
