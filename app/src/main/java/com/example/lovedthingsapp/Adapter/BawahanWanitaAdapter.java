...
public class BawahanWanitaAdapter extends RecyclerView.Adapter<BawahanWanitaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public BawahanWanitaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public BawahanWanitaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new BawahanWanitaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull BawahanWanitaAdapter.ViewHolder holder, int position) {
