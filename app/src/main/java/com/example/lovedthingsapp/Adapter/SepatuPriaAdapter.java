...
public class SepatuPriaAdapter extends RecyclerView.Adapter<SepatuPriaAdapter.ViewHolder> {

    private final ArrayList<Product> list;
    private final Context context;

    public SepatuPriaAdapter(ArrayList<Product> list, Context context) {
        this.list = list;
    ...
    @NonNull
    @Override
    public SepatuPriaAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder, parent, false);
        return new SepatuPriaAdapter.ViewHolder(inflate);
    }

    @Override
    public void onBindViewHolder(@NonNull SepatuPriaAdapter.ViewHolder holder, int position) {
